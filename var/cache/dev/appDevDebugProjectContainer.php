...
class appDevDebugProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            ...
            'poc.aareon.teamservice' => 'getPoc_Aareon_TeamserviceService',
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => NULL, 'dbname' => 'aareonpox', 'user' => 'root', 'password' => 'root', 'charset' => 'UTF8', 'driverOptions' => array(), 'defaultTableOptions' => array()), $b, $c, array());
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        ...
        $a->addDriver(new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($this->get('annotation_reader'), array(0 => ($this->targetDirs[3].'/src/POC/AareonBundle/Entity'))), 'POC\\AareonBundle\\Entity');

        $b = new \Doctrine\ORM\Configuration();
        $b->setEntityNamespaces(array('POCAareonBundle' => 'POC\\AareonBundle\\Entity'));
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_35ac00c73afc117d7f2aa68f19d906ddc45f83e1f4b49d585ffe631b67adddc4');
    ...
    /**
     * Gets the 'poc.aareon.teamservice' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \POC\AareonBundle\Services\TeamService A POC\AareonBundle\Services\TeamService instance.
     */
    protected function getPoc_Aareon_TeamserviceService()
    {
        return $this->services['poc.aareon.teamservice'] = new \POC\AareonBundle\Services\TeamService($this->get('doctrine.orm.default_entity_manager'));
    }
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'/src/POC/AareonBundle/Resources/views'), 'POCAareon');
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('bab4fa4c370c9b1fca8ec55c4c0565bbe02bf054');
    }
    ...
    {
        $this->services['security.authentication.manager'] = $instance = new \Symfony\Component\Security\Core\Authentication\AuthenticationProviderManager(array(0 => new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider('56de8bcc1abaf1.25059866')), true);
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'POCAareonBundle' => 'POC\\AareonBundle\\POCAareonBundle',
            ...
            'secret' => 'bab4fa4c370c9b1fca8ec55c4c0565bbe02bf054',
            'locale' => 'en',
            'fragment.renderer.hinclude.global_template' => NULL,
            'fragment.path' => '/_fragment',
            'kernel.secret' => 'bab4fa4c370c9b1fca8ec55c4c0565bbe02bf054',
